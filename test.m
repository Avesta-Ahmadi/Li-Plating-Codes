...
% Load results of optimal reconstruction
% make sure to load correct file from matlab folder
% make sure to import correct results
...
% testing model on other cycles and generating plots
% prepare global variables for forward function 
...
% % training on one cycle  and testing on all others, computing costs,
% % plotting
% fields = ['R2'; 'R3'; 'R4'; 'R5'; 'R6'];
% cost = zeros(max(size(fields)),max(size(fields)));
...
% figure('visible','on')
% plot(cost(1,:),'LineWidth',2, 'LineStyle','--', 'Marker', 'o', 'DisplayName', 'Trained on C3 Cycle')
% set(gca,'XTick',1:max(size(fields)),'XTickLabel',cycles)
% set(gca, 'YScale', 'log')
% hold on
% plot(cost(2,:),'LineWidth',2, 'LineStyle','--', 'Marker', 'o', 'DisplayName', 'Trained on C2 Cycle')
% plot(cost(3,:),'LineWidth',2, 'LineStyle','--', 'Marker', 'o', 'DisplayName', 'Trained on 1C Cycle')
% plot(cost(4,:),'LineWidth',2, 'LineStyle','--', 'Marker', 'o', 'DisplayName', 'Trained on 2C Cycle')
% plot(cost(5,:),'LineWidth',2, 'LineStyle','--', 'Marker', 'o', 'DisplayName', 'Trained on 3C Cycle')
