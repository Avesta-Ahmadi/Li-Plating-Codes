function [] = post_process_reconstruction_ensumble(omega_1, omega_2, c1forward_history, c2forward_history, omega_1_initial, omega_2_initial, lambda_history, foldername)
%%% -----------------------------------------------------------------
...
min1 = min([min(c1forward_history.R2(end,:)), min(c1forward_history.R3(end,:)), min(c1forward_history.R4(end,:)), min(c1forward_history.R5(end,:)), min(c1forward_history.R6(end,:))]);
max1 = max([max(c1forward_history.R2(end,:)), max(c1forward_history.R3(end,:)), max(c1forward_history.R4(end,:)), max(c1forward_history.R5(end,:)), max(c1forward_history.R6(end,:))]);
...
legend('interpreter','latex','Location','best','FontSize',15);
min2 = min([min(c2forward_history.R2(end,:)), min(c2forward_history.R3(end,:)), min(c2forward_history.R4(end,:)), min(c2forward_history.R5(end,:)), min(c2forward_history.R6(end,:))]);
max2 = max([max(c2forward_history.R2(end,:)), max(c2forward_history.R3(end,:)), max(c2forward_history.R4(end,:)), max(c2forward_history.R5(end,:)), max(c2forward_history.R6(end,:))]);
