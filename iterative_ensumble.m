function [omega_1, omega_2, lambda, c1forward_history, c2forward_history, L2gradJ1_history, L2gradJ2_history, H1gradJ1_history, H1gradJ2_history, omega_1_history, omega_2_history, lambda_history] = iterative_ensumble(omega_1, omega_2, lambda, plt, foldername)
%%% -----------------------------------------------------------------
% the iterative scheme of minimization
% Input:     experimental data in time
% Output:    computed omega(c1,c2)

global c1grid c2grid Ngrid timeseq Nt Feval LineMin1 LineMin2 c1alpha c1beta c2alpha c2beta I rho_1 rho_2 C0 c1tilde c2tilde
...
MAX_ITER       = 20;        % Maximum number of iterations of algorithm;
...
while (n <= MAX_ITER) && (abs(Jtau_omega_20 - Jtau_omega_2) / abs(Jtau_omega_2) > Tol_J)
    ...
    cforward = struct;
    cforward.R2 = forward_ensumble(omega_1, omega_2, lambda, timeseq.R2, I.R2, C0.R2);
    cforward.R3 = forward_ensumble(omega_1, omega_2, lambda, timeseq.R3, I.R3, C0.R3);
    cforward.R4 = forward_ensumble(omega_1, omega_2, lambda, timeseq.R4, I.R4, C0.R4);
    cforward.R5 = forward_ensumble(omega_1, omega_2, lambda, timeseq.R5, I.R5, C0.R5);
    cforward.R6 = forward_ensumble(omega_1, omega_2, lambda, timeseq.R6, I.R6, C0.R6);
...
%     end
    ...
    cstar = struct;
    cstar.R2 = adjoint_ensumble(omega_1, omega_2, cforward.R2, lambda, c1tilde.R2, c2tilde.R2, timeseq.R2, I.R2);
    cstar.R3 = adjoint_ensumble(omega_1, omega_2, cforward.R3, lambda, c1tilde.R3, c2tilde.R3, timeseq.R3, I.R3);
    cstar.R4 = adjoint_ensumble(omega_1, omega_2, cforward.R4, lambda, c1tilde.R4, c2tilde.R4, timeseq.R4, I.R4);
    cstar.R5 = adjoint_ensumble(omega_1, omega_2, cforward.R5, lambda, c1tilde.R5, c2tilde.R5, timeseq.R5, I.R5);
    cstar.R6 = adjoint_ensumble(omega_1, omega_2, cforward.R6, lambda, c1tilde.R6, c2tilde.R6, timeseq.R6, I.R6);
    ...
    for i = 1:size(timeseq.R2,1)
        ...
        gt1.R2(i) = + cstar.R2(i,1)/om1 - 3*cstar.R2(i,2)/om1;
        gt2.R2(i) = + (cstar.R2(i,1)*om1)/(3*(1-om1*om2)) - (cstar.R2(i,2)*om1)/(1-om1*om2);
    end
    ...
    for i = 1:size(timeseq.R3,1)
        ...
        gt1.R3(i) = + cstar.R3(i,1)/om1 - 3*cstar.R3(i,2)/om1;
        gt2.R3(i) = + (cstar.R3(i,1)*om1)/(3*(1-om1*om2)) - (cstar.R3(i,2)*om1)/(1-om1*om2);
    end
    ...
    for i = 1:size(timeseq.R4,1)
        ...
        gt1.R4(i) = + cstar.R4(i,1)/om1 - 3*cstar.R4(i,2)/om1;
        gt2.R4(i) = + (cstar.R4(i,1)*om1)/(3*(1-om1*om2)) - (cstar.R4(i,2)*om1)/(1-om1*om2);
    end
    ...
    for i = 1:size(timeseq.R5,1)
        ...
        gt1.R5(i) = + cstar.R5(i,1)/om1 - 3*cstar.R5(i,2)/om1;
        gt2.R5(i) = + (cstar.R5(i,1)*om1)/(3*(1-om1*om2)) - (cstar.R5(i,2)*om1)/(1-om1*om2);
    end
    ...
    for i = 1:size(timeseq.R6,1)
        ...
        gt1.R6(i) = + cstar.R6(i,1)/om1 - 3*cstar.R6(i,2)/om1;
        gt2.R6(i) = + (cstar.R6(i,1)*om1)/(3*(1-om1*om2)) - (cstar.R6(i,2)*om1)/(1-om1*om2);
    end
    ...
    for i = 1:size(timeseq.R2,1)
        om1 = interp1(c1grid, omega_1, cforward.R2(i,1),'spline');
        om2 = interp1(c2grid, omega_2, cforward.R2(i,2),'spline');
        integrand.R2(i) = rho_1(I.R2(i))*om1*om2*cstar.R2(i,1) + rho_2(I.R2(i))*(1-om1*om2)*cstar.R2(i,2);
    end
    ...
    for i = 1:size(timeseq.R3,1)
        om1 = interp1(c1grid, omega_1, cforward.R3(i,1),'spline');
        om2 = interp1(c2grid, omega_2, cforward.R3(i,2),'spline');
        integrand.R3(i) = rho_1(I.R3(i))*om1*om2*cstar.R3(i,1) + rho_2(I.R3(i))*(1-om1*om2)*cstar.R3(i,2);
    end
    ...
    for i = 1:size(timeseq.R4,1)
        om1 = interp1(c1grid, omega_1, cforward.R4(i,1),'spline');
        om2 = interp1(c2grid, omega_2, cforward.R4(i,2),'spline');
        integrand.R4(i) = rho_1(I.R4(i))*om1*om2*cstar.R4(i,1) + rho_2(I.R4(i))*(1-om1*om2)*cstar.R4(i,2);
    end
    ...
    for i = 1:size(timeseq.R5,1)
        om1 = interp1(c1grid, omega_1, cforward.R5(i,1),'spline');
        om2 = interp1(c2grid, omega_2, cforward.R5(i,2),'spline');
        integrand.R5(i) = rho_1(I.R5(i))*om1*om2*cstar.R5(i,1) + rho_2(I.R5(i))*(1-om1*om2)*cstar.R5(i,2);
    end
    ...
    for i = 1:size(timeseq.R6,1)
        om1 = interp1(c1grid, omega_1, cforward.R6(i,1),'spline');
        om2 = interp1(c2grid, omega_2, cforward.R6(i,2),'spline');
        integrand.R6(i) = rho_1(I.R6(i))*om1*om2*cstar.R6(i,1) + rho_2(I.R6(i))*(1-om1*om2)*cstar.R6(i,2);
    end
    pj.R6 = trapz(timeseq.R6, integrand.R6);
    pjpl = pj.R2 + pj.R3 + pj.R4 + pj.R5 + pj.R6;
    ...
    %lambda
    Jtau1 = Jeval_ensumble(tau1, omega_1, omega_2, lambda, DDl, which);
    Jtau2 = Jeval_ensumble(tau2, omega_1, omega_2, lambda, DDl, which);
    % mnbrak for omega_1
    [tau1, Jtau1, tau2, Jtau2, tau3, Jtau3] = mnbrak_ensumble(tau1, tau2, Jtau1, Jtau2, omega_1, omega_2, lambda, DDl, which, MAXITER);
    % brent for omega_1
    Jtau_lambda0 = Jtau_lambda;
    [tau_lambda, Jtau_lambda] = Brent_ensumble(tau1, tau2, tau3, Jtau1, Jtau2, Jtau3, Tol_Brent, MAX_ITER_BRENT, omega_1, omega_2, lambda, DDl, which);
    ...
    Jtau1 = Jeval_ensumble(tau1, omega_1, omega_2, lambda, DD1, which);
    Jtau2 = Jeval_ensumble(tau2, omega_1, omega_2, lambda, DD1, which);
    % mnbrak_ensumble for omega_1
    [tau1, Jtau1, tau2, Jtau2, tau3, Jtau3] = mnbrak_ensumble(tau1, tau2, Jtau1, Jtau2, omega_1, omega_2, lambda, DD1, which, MAXITER);
    % brent for omega_1
    Jtau_omega_10 = Jtau_omega_1;
    [tau_omega_1, Jtau_omega_1] = Brent_ensumble(tau1, tau2, tau3, Jtau1, Jtau2, Jtau3, Tol_Brent, MAX_ITER_BRENT, omega_1, omega_2, lambda, DD1, which);
    ...
    Jtau1 = Jeval_ensumble(tau1, omega_1, omega_2, lambda, DD2, which);
    Jtau2 = Jeval_ensumble(tau2, omega_1, omega_2, lambda, DD2, which);
    [tau1, Jtau1, tau2, Jtau2, tau3, Jtau3] = mnbrak_ensumble(tau1, tau2, Jtau1, Jtau2, omega_1, omega_2, lambda, DD2, which, MAXITER);
    Jtau_omega_20 = Jtau_omega_2;
    [tau_omega_2, Jtau_omega_2] = Brent_ensumble(tau1, tau2, tau3, Jtau1, Jtau2, Jtau3, Tol_Brent, MAX_ITER_BRENT, omega_1, omega_2, lambda, DD2, which);
