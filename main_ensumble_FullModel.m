...
Feval = 0;
plt = false;
mkdir Charge_results/ensumble;
foldername = '/Charge_results/ensumble';
...
[omega_1, omega_2, lambda, c1forward_history, c2forward_history, L2gradJ1_history, L2gradJ2_history, H1gradJ1_history, H1gradJ2_history, ...
    omega_1_history, omega_2_history, lambda_history, Jtau_history] = iterative_ensumble_FullModel(omega_1_initial, omega_2_initial, lambda_initial, plt, foldername);
...
% save variables
% save variables
save('Charge_results/ensumble/Results_Charge_ensumble.mat',"C0","c1alpha","c1beta","c2alpha","c2beta","c1grid","c2grid","c1tilde","c2tilde","dC1","dC2","Ngrid","Nt",...
...
Feval = 0;
plt = false;
mkdir Discharge_results/ensumble;
foldername = '/Discharge_results/ensumble';
...
% save variables
% save variables
save('Discharge_results/ensumble/Results_Discharge_ensumble.mat',"C0","c1alpha","c1beta","c2alpha","c2beta","c1grid","c2grid","c1tilde","c2tilde","dC1","dC2","Ngrid","Nt",...
    "omega_1_initial","omega_2_initial","omega_1", "omega_2", "c1forward_history", "c2forward_history", "L2gradJ1_history", ...
    "L2gradJ2_history","H1gradJ1_history","H1gradJ2_history", "omega_1_history", "omega_2_history", "sdata", "cm", "tm", ...
    "A", "L_a", "F", "a", "weight", "lambda_initial", "lambda", "lambda_history","Jtau_history", "beta");
