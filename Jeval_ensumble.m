function [jj] = Jeval_ensumble(tau, omega_1, omega_2, lambda, DD, which)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
c1 = forward_ensumble(omega_1_n, omega_2_n, lambda_n, timeseq.R2, I.R2, C0.R2);
jj1 = J(c1,c1tilde.R2,c2tilde.R2,timeseq.R2);

c2 = forward_ensumble(omega_1_n, omega_2_n, lambda_n, timeseq.R3, I.R3, C0.R3);
jj2 = J(c2,c1tilde.R3,c2tilde.R3,timeseq.R3);

c3 = forward_ensumble(omega_1_n, omega_2_n, lambda_n, timeseq.R4, I.R4, C0.R4);
jj3 = J(c3,c1tilde.R4,c2tilde.R4,timeseq.R4);

c4 = forward_ensumble(omega_1_n, omega_2_n, lambda_n, timeseq.R5, I.R5, C0.R5);
jj4 = J(c4,c1tilde.R5,c2tilde.R5,timeseq.R5);

c5 = forward_ensumble(omega_1_n, omega_2_n, lambda_n, timeseq.R6, I.R6, C0.R6);
