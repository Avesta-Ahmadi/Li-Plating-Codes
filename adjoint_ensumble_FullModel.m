function [cstar] = adjoint_ensumble_FullModel(Omega_1, Omega_2, cforward, lambda, c1tilde, c2tilde, timeseq, I)
%%% -----------------------------------------------------------------
...
% is used for when fitting to all cycles.
...
global c1grid c2grid Ngrid weight beta
