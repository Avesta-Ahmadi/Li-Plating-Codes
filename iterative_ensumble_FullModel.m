function [omega_1, omega_2, lambda, c1forward_history, c2forward_history, L2gradJ1_history, L2gradJ2_history, H1gradJ1_history, H1gradJ2_history, omega_1_history, omega_2_history, lambda_history, Jtau_history_3] = iterative_ensumble_FullModel(omega_1, omega_2, lambda, plt, foldername)
%%% -----------------------------------------------------------------
...
%     end
    ...
    lambda
    Jtau1 = Jeval_ensumble_FullModel(tau1, omega_1, omega_2, lambda, DDl, which);
    Jtau2 = Jeval_ensumble_FullModel(tau2, omega_1, omega_2, lambda, DDl, which);
    % mnbrak for omega_1
    [tau1, Jtau1, tau2, Jtau2, tau3, Jtau3] = mnbrak_ensumble_FullModel(tau1, tau2, Jtau1, Jtau2, omega_1, omega_2, lambda, DDl, which, MAXITER);
    % brent for omega_1
    Jtau_lambda0 = Jtau_lambda;
    [tau_lambda, Jtau_lambda] = Brent_ensumble_FullModel(tau1, tau2, tau3, Jtau1, Jtau2, Jtau3, Tol_Brent, MAX_ITER_BRENT, omega_1, omega_2, lambda, DDl, which);
    ...
    Jtau1 = Jeval_ensumble_FullModel(tau1, omega_1, omega_2, lambda, DD1, which);
    Jtau2 = Jeval_ensumble_FullModel(tau2, omega_1, omega_2, lambda, DD1, which);
    % mnbrak_ensumble for omega_1
    [tau1, Jtau1, tau2, Jtau2, tau3, Jtau3] = mnbrak_ensumble_FullModel(tau1, tau2, Jtau1, Jtau2, omega_1, omega_2, lambda, DD1, which, MAXITER);
    % brent for omega_1
    Jtau_omega_10 = Jtau_omega_1;
    [tau_omega_1, Jtau_omega_1] = Brent_ensumble_FullModel(tau1, tau2, tau3, Jtau1, Jtau2, Jtau3, Tol_Brent, MAX_ITER_BRENT, omega_1, omega_2, lambda, DD1, which);
    ...
    Jtau1 = Jeval_ensumble_FullModel(tau1, omega_1, omega_2, lambda, DD2, which);
    Jtau2 = Jeval_ensumble_FullModel(tau2, omega_1, omega_2, lambda, DD2, which);
    [tau1, Jtau1, tau2, Jtau2, tau3, Jtau3] = mnbrak_ensumble_FullModel(tau1, tau2, Jtau1, Jtau2, omega_1, omega_2, lambda, DD2, which, MAXITER);
    Jtau_omega_20 = Jtau_omega_2;
    [tau_omega_2, Jtau_omega_2] = Brent_ensumble_FullModel(tau1, tau2, tau3, Jtau1, Jtau2, Jtau3, Tol_Brent, MAX_ITER_BRENT, omega_1, omega_2, lambda, DD2, which);
