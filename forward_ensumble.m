function [c] = forward_ensumble(Omega_1, Omega_2, lambda, timeseq, I, C0)
%%% -----------------------------------------------------------------
% solve forward ODE system as a forward problem only for the nonlinear part
% of the model, asssuming there is no linear part.
...
global c1grid c2grid rho_1 rho_2 sf 
