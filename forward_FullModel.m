function [c] = forward_FullModel(Omega_1, Omega_2, lambda)
%%% -----------------------------------------------------------------
% solve forward ODE system as a forward problem assuming that the ODE model
% has a linear and a nonlinear part. In this case, the beta parameters are
% known and passed to the model.
...
global c1grid c2grid timeseq I C0 beta
